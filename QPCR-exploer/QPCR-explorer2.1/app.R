    ...
    tabPanel(
        ...
        sidebarLayout(
            sidebarPanel(
                ...
                tags$style(HTML(".js-irs-0 .irs-single, .js-irs-0 .irs-bar-edge, .js-irs-0 .irs-bar {background: #81b214}")),
                sliderInput('alpha','Column alpha',min = 0,max = 1,value = 1,step = 0.1),
                fluidRow(column(6,
