...
ui2 <- dashboardPage(
dashboardHeader(title = 'Enrichment Analysis tool!'),
        ...
        {tabItem(tabName = 'Introduction',
                 ...
                 fluidRow(box(title = 'genelist format',solidHeader = F,collapsible = F,status="success",width = 4,
                          ...
                          box(title = 'Dotplot data format',solidHeader = F,collapsible = F,status="success",width = 6,
                              h4('Note: This data is from KABAS web analysis , the column "Enrich_ratio" should have the same name .'),
                              hr(),
...
# ui2 <- dashboardPage(skin = "green",header, sidebar, body)
