    ...
    tabPanel('vennplot',icon = icon('cc-mastercard'),
             sidebarLayout(
                 sidebarPanel(h4(p('Venn plot to intersect diffrent groups elements,2021/04/25 by JunZhang.')),
                              ...
                              radioButtons('slect_data',h4('upload or paste data?',style="color:#fab696"),choices = c('upload','paste'),selected = 'upload',inline = T),
                     fileInput('data',
                     ...
                     radioGroupButtons(
                         inputId = "set_number",label = h4("Choose set number",style="color:#3fc5f0"),size = 'normal',
                     ...
                     fluidRow(column(6,numericInput('rotation_degree','rotation degree',min = 0,max = 360,value = 0,step = 1)),
                              column(6,colourInput('color','select color name here',value = '#23D996')),
                              ),
                 ...
                 mainPanel(
                     tabsetPanel(
                         tabPanel('Hint',icon = icon('laugh-beam'),
                                  ...
                                  h3("These pictures shows the meaning of the parameters and teach you how to draw a great venn plot!"),
                         ...
                         tabPanel('Two group Venn',icon = icon('flickr'),
                                  ...
                                  dropdownButton(
                                      ...
                                      fluidRow(column(6,textInput('two_name1','group name1',value = NULL),
                                                      textAreaInput('two_list1','list1',value = NULL,rows = 10)),
                                               column(6,textInput('two_name2','group name2',value = NULL),
                                                      textAreaInput('two_list2','list2',value = NULL,rows = 10))),
                                      
                                      circle = TRUE, status = "danger",
                                      icon = icon("file-alt"), width = "300px",
                                      tooltip = tooltipOptions(title = "Click to see inputs !")
                                  ),
                                  
                                  p('You can also paste list directly here!',style="color:white"),
                         ...
                         tabPanel('Three group Venn',icon = icon('flickr'),
                                  ...
                                  dropdownButton(
                                      ...
                                      fluidRow(column(4,textInput('three_name1','group name1',value = NULL),
                                                      textAreaInput('three_list1','list1',value = NULL,rows = 10)),
                                               column(4,textInput('three_name2','group name2',value = NULL),
                                                      textAreaInput('three_list2','list2',value = NULL,rows = 10)),
                                               column(4,textInput('three_name3','group name3',value = NULL),
                                                      textAreaInput('three_list3','list3',value = NULL,rows = 10))),
                                      
                                      circle = TRUE, status = "danger",
                                      icon = icon("file-alt"), width = "400px",
                                      tooltip = tooltipOptions(title = "Click to see inputs !")
                                  ),
                         ...
                         tabPanel('Four group Venn',icon = icon('flickr'),
                                  ...
                                  dropdownButton(
                                      ...
                                      fluidRow(column(3,textInput('four_name1','group name1',value = NULL),
                                                      textAreaInput('four_list1','list1',value = NULL,rows = 10)),
                                               column(3,textInput('four_name2','group name2',value = NULL),
                                                      textAreaInput('four_list2','list2',value = NULL,rows = 10)),
                                               column(3,textInput('four_name3','group name3',value = NULL),
                                                      textAreaInput('four_list3','list3',value = NULL,rows = 10)),
                                               column(3,textInput('four_name4','group name4',value = NULL),
                                                      textAreaInput('four_list4','list4',value = NULL,rows = 10))),
                                      
                                      circle = TRUE, status = "danger",
                                      icon = icon("file-alt"), width = "550px",
                                      tooltip = tooltipOptions(title = "Click to see inputs !")
                                  ),
                         ...
                         tabPanel('Five group Venn',icon = icon('flickr'),
                                  ...
                                  dropdownButton(
                                      ...
                                      fluidRow(column(2,textInput('five_name1','group name1',value = NULL),
                                                      textAreaInput('five_list1','list1',value = NULL,rows = 10)),
                                               column(2,textInput('five_name2','group name2',value = NULL),
                                                      textAreaInput('five_list2','list2',value = NULL,rows = 10)),
                                               column(2,textInput('five_name3','group name3',value = NULL),
                                                      textAreaInput('five_list3','list3',value = NULL,rows = 10)),
                                               column(2,textInput('five_name4','group name4',value = NULL),
                                                      textAreaInput('five_list4','list4',value = NULL,rows = 10)),
                                               column(2,textInput('five_name5','group name5',value = NULL),
                                                      textAreaInput('five_list5','list5',value = NULL,rows = 10))),
                                      
                                      circle = TRUE, status = "danger",
                                      icon = icon("file-alt"), width = "700px",
                                      tooltip = tooltipOptions(title = "Click to see inputs !")
                                  ),
...
server <- function(input, output, session) {
    ...
    {two_plot <- reactive({
        ...
        # to list with paste data
        lisn1 <- input$two_name1
        lisn2 <- input$two_name2
        dat_list <- list(lisn1 = unlist(strsplit(input$two_list1,split = '\n')), 
                         lisn2 = unlist(strsplit(input$two_list2,split = '\n')))
        names(dat_list) <- c(lisn1,lisn2)
        }
        # -----------------------------------------
        # fill color split
    ...
    {three_plot <- reactive({
        ...
        names(dat_list) <- c(n1,n2,n3)
            ...
            # to list with paste data
            lisn1 <- input$three_name1
            lisn2 <- input$three_name2
            lisn3 <- input$three_name3
            dat_list <- list(lisn1 = unlist(strsplit(input$three_list1,split = '\n')), 
                             lisn2 = unlist(strsplit(input$three_list2,split = '\n')),
                             lisn3 = unlist(strsplit(input$three_list3,split = '\n')))
            names(dat_list) <- c(lisn1,lisn2,lisn3) 
        }
        # -----------------------------------------
        # fill color split
        input_fill_color <- unlist(strsplit(input$fill,split = '_'))
    ...
    {four_plot <- reactive({
        ...
        names(dat_list) <- c(n1,n2,n3,n4)
            ...
            # to list with paste data
            lisn1 <- input$four_name1
            lisn2 <- input$four_name2
            lisn3 <- input$four_name3
            lisn4 <- input$four_name4
            dat_list <- list(lisn1 = unlist(strsplit(input$four_list1,split = '\n')), 
                             lisn2 = unlist(strsplit(input$four_list2,split = '\n')),
                             lisn3 = unlist(strsplit(input$four_list3,split = '\n')),
                             lisn4 = unlist(strsplit(input$four_list4,split = '\n')))
            names(dat_list) <- c(lisn1,lisn2,lisn3,lisn4) 
        }
        # -----------------------------------------
        # fill color split
        input_fill_color <- unlist(strsplit(input$fill,split = '_'))
    ...
    {five_plot <- reactive({
        ...
        names(dat_list) <- c(n1,n2,n3,n4,n5)
            ...
            # to list with paste data
            lisn1 <- input$five_name1
            lisn2 <- input$five_name2
            lisn3 <- input$five_name3
            lisn4 <- input$five_name4
            lisn5 <- input$five_name5
            dat_list <- list(lisn1 = unlist(strsplit(input$five_list1,split = '\n')), 
                             lisn2 = unlist(strsplit(input$five_list2,split = '\n')),
                             lisn3 = unlist(strsplit(input$five_list3,split = '\n')),
                             lisn4 = unlist(strsplit(input$five_list4,split = '\n')),
                             lisn5 = unlist(strsplit(input$five_list5,split = '\n')))
            names(dat_list) <- c(lisn1,lisn2,lisn3,lisn4,lisn5) 
        }
        # -----------------------------------------
        # fill color split
        input_fill_color <- unlist(strsplit(input$fill,split = '_'))
