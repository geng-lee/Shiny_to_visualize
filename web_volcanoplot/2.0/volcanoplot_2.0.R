        ...
        sidebarPanel(width = 3,
            fileInput('data',
                      ...
                      accept = c("text/csv",
                                 ...
                                 ".csv")),
            tags$strong('Note: Your input file column name must be " log2FoldChange " , " pvalue " , " baseMean " and " gene_name ",
...
################################################################################        
        ...
        mainPanel(
            ...
            "Thank you for your support ,learning shiny on this website : https://shiny.rstudio.com/tutorial/ , if you have any advice or suggestions,please connect me .(Jun Zhang)",
                        ...
                        tabPanel("Volcano Plot",
                                 ...
                                 plotOutput("volcaplot",height = 550,width = 700),
                                             fluidRow(column(width = 4,
                                                             ...
                                                             'Up gene shape:',
                                                             choices = c('方形'=15,'圆形'=16,'上三角'=17,'空心上三角'=2,
                                                                         '空心下三角'=6,'菱形'=18,'五角星'=11,'十字架'=3),
                                                             selected=16,
                                                             width = 150))),
                                                      column(width = 4,
